package com.hoggen.sublimation.util.SensitiveFilter;
...
public class KeyWordFilter {
	public static final String PATH_DIC_WFC = "wfc.dic";//"sensi_words.txt";
	public static final String PATH_DIC_FQC = "wfc.dic";//"sensi_words.txt";
	...
	private HashMap<String, String> getWordMap(String dicPath, String replace) {
		...
		try {
			ClassPathResource resource = new ClassPathResource(dicPath);
			// is = new FileInputStream(dicPath);
			is = resource.getInputStream();//KeyWordFilter.class.getResourceAsStream(dicPath);
			if (is == null) {
	...
	public static void main(String[] args) {
		...
		if (WordFilter.containRubbish(str)){
			System.out.println("包含有敏感词汇1");
		}else {
			System.out.println("不包含有敏感词汇1");
		}

		if (WordFilter.containRubbish("一个网站就像一个人2")){
			System.out.println("包含有敏感词汇2");
		}else {
			System.out.println("不包含有敏感词汇2");
		}
		System.out.println("测试1：  " + WordFilter.containRubbish("淫荡"));
		System.out.println("测试2：  " + WordFilter.containRubbish("贱货"));
		System.out.println("测试3：  " + WordFilter.containRubbish("穴居兽"));
		System.out.println("测试4：  " + WordFilter.containRubbish("美女"));
		System.out.println("测试5：  " + WordFilter.containRubbish("漂亮的剑舞"));
		System.out.println("测试6：  " + WordFilter.containRubbish("可爱的春天"));
