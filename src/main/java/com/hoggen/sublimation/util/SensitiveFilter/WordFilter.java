...
public class WordFilter {
	public static KeyWordFilter kwf = KeyWordFilter.getInstance();
...
//	}
	...
	public static   boolean containRubbish(String content) {
		String leftContent = WordFilter.kwf.filter_search(content);
		System.out.println(leftContent);
		if (leftContent.equals(content) ) {
			return  false;
		}
		return  true;
	}
